...
const sortByChildren = (charArray) => {
  // Sort the characters array by the number of children in each house
  charArray.sort((a, b) => a.children.length - b.children.length);

  // If two houses have the same number of children, sort alphabetically by house name
  charArray.sort((a, b) => {
...
------------------------------------------------------------------------------------------------ */
const containsW = (str) => {
  // Create a regular expression pattern to match the letter 'w' in lower case
  const pattern = /w/;
...
console.log(containsW('Hello, world!')); // true
console.log(containsW('Goodbye')); // false
...
------------------------------------------------------------------------------------------------ */
const isNum = (input) => {
  // Create a regular expression pattern to match a number
  const pattern = /\d/;

  // Use the test method to check if the pattern matches the input
...
const containsWorld = (input) => {
  // Create a regular expression pattern to match the word 'world'
  const pattern = /world/;
...
console.log(containsWorld('goodbye world')); // true
console.log(containsWorld('hello')); // false
console.log(containsWorld(12345)); // false
...
const isCapitalized = (str) => {
  // Create a regular expression pattern to match capitalized words
...
console.log(isCapitalized('The quick Brown Fox')); // ["The", "Brown", "Fox"]
console.log(isCapitalized('Hello World!')); // ["Hello", "World"]
console.log(isCapitalized('JavaScript is fun')); // ["JavaScript"]
console.log(isCapitalized('this is a test')); // []
