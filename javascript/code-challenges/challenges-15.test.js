...
console.log(isSecure('http://www.insecure.com')); // Output: false
console.log(isSecure('https://secure.com')); // Output: true
console.log(isSecure('https:/missingslash.org')); // Output: false
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
