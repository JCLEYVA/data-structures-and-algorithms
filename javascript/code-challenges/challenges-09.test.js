...
const hasChildrenValues = (arr, character) => {
  ...
  // If the character object exists, check if they have children
  if (char) {
    const children = Object.values(char.children);
    return children.length > 0;
  }

  // If the character object doesn't exist, return false
  return false;
};

console.log(hasChildrenValues(characters, 'Cersei')); // true
console.log(hasChildrenValues(characters, 'Sansa')); // false
